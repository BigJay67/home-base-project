// Updated NewListing.js with proper createdBy field
...
function NewListing({ user }) {
  ...
  // Update the handleSubmit function in NewListing.js
const handleSubmit = async (e) => {
  ...
  try {
    ...
    // Get the response text first to handle both JSON and text errors
